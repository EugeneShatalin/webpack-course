...
// CONCATENATED MODULE: ./src/modules/header.component.js
 //импортируем библиотеку jquery в переменную $

jquery_default()('<h1 />')//создаем элемент с помощью библиотеки
    .text('Hello world from JQuery') //вставляем текст в элемент
    .css({ //создаем стили
        textAlign: 'center',
        color: 'blue'
    })
    .appendTo(jquery_default()('header')) //элемент импортируем в тег header
